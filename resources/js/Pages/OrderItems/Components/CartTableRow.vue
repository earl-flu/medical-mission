...
<template>
  ...
  >
    <td class="break-all text-wrap pl-3">
      <div
        @click="cart.removeOrderedItem(props.orderedItem.id)"
        class="close-btn h-7 w-7 rounded-full border text-center flex items-center justify-center cursor-pointer border-red-300 text-red-500 hover:bg-red-500 hover:text-white transition-all"
      >
        X
      </div>
    </td>
