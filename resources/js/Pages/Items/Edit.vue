    ...
    <AuthenticatedLayout>
        <template #header>
            ...
            <p class="text-xs text-gray-500 mt-2 ">
                <Link :href="route('items.index')"><span class="text-indigo-500">Items</span></Link> >
                {{ item.name }}
                >
                <span>Edit Item</span>
            </p>
                        ...
                        <form @submit.prevent="submit()">
                            ...
                            <div class="">
                                ...
                                <div class="relative z-0 w-full mb-6 group">
                                    ...
                                    <TextInput name="restock_threshold" id="restock_threshold" type="number"
                                        class="mt-1 block w-full" placeholder=" " v-model="form.restock_threshold" required
